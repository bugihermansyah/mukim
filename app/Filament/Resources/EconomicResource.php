...
class EconomicResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Status Ekonomi Keluarga';

    protected static ?string $pluralModelLabel = 'Status Ekonomi Keluarga';
    ...
    {
        return [
            'index' => Pages\ListEconomics::route('/'),
            'create' => Pages\CreateEconomic::route('/create'),
            'edit' => Pages\EditEconomic::route('/{record}/edit'),
        ];
    }    

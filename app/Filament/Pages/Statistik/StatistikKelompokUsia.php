...
use App\Filament\Widgets\WargaKelompokUsiaChart;
...
class StatistikKelompokUsia extends Page
{
    use HasPageSidebar;
    
    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.statistik.statistik-kelompok-usia';

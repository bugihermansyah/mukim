...
use App\Filament\Widgets\WargaEducationChart;
...
class StatistikEducation extends Page
{
    use HasPageSidebar;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.statistik.statistik-education';
